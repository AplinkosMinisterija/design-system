...
const DateField = ({
  ...
  const handleRemoveAction = useKeyAction(() => onChange(undefined), disabled);
  const handleToggleAction = useKeyAction(() => setOpen(!open), disabled);
  useEffect(() => {
