...
`,Oe=rt,nt=({visible:e=!0,loggedIn:t,currentRoute:a,routes:o,onLogin:s,onLogout:f,onRouteSelected:m,onClose:p})=>n.jsx(Oe,{visible:e,onClose:p,children:n.jsx(ot,{children:n.jsxs(at,{children:[n.jsx(lt,{children:n.jsxs(st,{onClick:p,children:[n.jsx(it,{name:"close"}),"Uždaryti"]})}),n.jsxs(ct,{children:[n.jsx(ut,{children:"Meniu"}),n.jsx(dt,{children:"Pasirinkite dominančią sritį"})]}),o==null?void 0:o.map((u,w)=>n.jsx(_e,{isActive:u.slug===(a==null?void 0:a.slug),label:u.title||"",icon:u.iconName,onClick:()=>{m(u.slug),p()}},`menu_button_${w}`)),n.jsx(_e,{label:t?"Atsijungti":"Prisijungti",icon:I.logout,onClick:()=>{t?f():(s(),p())}})]})})}),it=c(z)`
  cursor: pointer;
  font-size: 2.4rem;
`,ot=c(oe)`
  width: 100%;
...
`,dt=c.div`
  ...
  margin-top: 4px;
  text-align: center;
`,Se=nt,ft=e=>{const{onGoBack:t}=e,[a,o]=x.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsxs(pt,{children:[n.jsx(vt,{onClick:t,children:n.jsx(xt,{name:I.back})}),n.jsxs(ht,{onClick:()=>o(!0),children:[n.jsx(gt,{name:I.burger}),"Meniu"]})]}),n.jsx(Se,{visible:a,onClose:()=>o(!1),...e})]})},pt=c.div`
  align-items: center;
  display: flex;
  gap: 8px;
  height: 80px;
...
`,mt=ft,bt=e=>{const{onGoHome:t,logo:a}=e,[o,s]=x.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsxs(wt,{children:[n.jsx("div",{onClick:t,children:a}),n.jsxs(yt,{onClick:()=>s(!0),children:[n.jsx(jt,{name:I.burger}),"Meniu"]})]}),n.jsx(Se,{visible:o,onClose:()=>s(!1),...e})]})},wt=c.div`
  align-items: center;
  display: flex;
  gap: 8px;
  height: 80px;
...
`,jt=c(z)`
  margin-right: 4px;
  font-size: 2rem;
`,$t=bt,kt=({loggedIn:e,loginSlug:t,routes:a,logo:o,onLogin:s,onLogout:f,onRouteSelected:m,currentRoute:p})=>n.jsxs(Ct,{children:[n.jsx(Et,{children:o}),a.map((u,w)=>n.jsxs(se,{onClick:()=>m(u.slug),$isActive:u.slug===(p==null?void 0:p.slug),children:[n.jsx(q,{name:u.iconName}),n.jsx(ae,{children:u.title})]},`sidebar_btn_${u.slug}_${w}`)),n.jsx(_t,{}),e?n.jsxs(se,{onClick:()=>f(),$isActive:!1,children:[n.jsx(q,{name:I.logout}),n.jsx(ae,{children:"Atsijungti"})]}):n.jsxs(se,{onClick:s,$isActive:t===(p==null?void 0:p.slug),children:[n.jsx(q,{name:I.logout}),n.jsx(ae,{children:"Prisijungti"})]})]}),Et=c.div`
  margin-bottom: 20px;
`,q=c(z)`
  cursor: pointer;
  font-size: 2.4rem;
