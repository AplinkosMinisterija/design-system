(function(k,x){typeof exports=="object"&&typeof module<"u"?x(exports,require("react"),require("styled-components")):typeof define=="function"&&define.amd?define(["exports","react","styled-components"],x):(k=typeof globalThis<"u"?globalThis:k||self,x(k["design-system"]={},k.React,k["styled-components"]))})(this,function(k,x,c){"use strict";var ne={exports:{}},N={};/**
 * @license React
 ...
 */var xe;function er(){if(xe)return N;xe=1;var e=x,t=Symbol.for("react.element"),a=Symbol.for("react.fragment"),o=Object.prototype.hasOwnProperty,s=e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,f={key:!0,ref:!0,__self:!0,__source:!0};function m(h,u,w){var y,E={},_=null,S=null;w!==void 0&&(_=""+w),u.key!==void 0&&(_=""+u.key),u.ref!==void 0&&(S=u.ref);for(y in u)o.call(u,y)&&!f.hasOwnProperty(y)&&(E[y]=u[y]);if(h&&h.defaultProps)for(y in u=h.defaultProps,u)E[y]===void 0&&(E[y]=u[y]);return{$$typeof:t,type:h,key:_,ref:S,props:E,_owner:s.current}}return N.Fragment=a,N.jsx=m,N.jsxs=m,N}var H={};/**
 * @license React
...
Check the top-level render call using <`+l+">.")}return i}}function Xe(r,i){{if(!r._store||r._store.validated||r.key!=null)return;r._store.validated=!0;var l=un(i);if(Je[l])return;Je[l]=!0;var d="";r&&r._owner&&r._owner!==pe.current&&(d=" It was passed a child from "+F(r._owner.type)+"."),Y(r),C('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.',l,d),Y(null)}}function Ke(r,i){{if(typeof r!="object")return;if(de(r))for(var l=0;l<r.length;l++){var d=r[l];ge(d)&&Xe(d,i)}else if(ge(r))r._store&&(r._store.validated=!0);else if(r){var v=W(r);if(typeof v=="function"&&v!==r.entries)for(var b=v.call(r),g;!(g=b.next()).done;)ge(g.value)&&Xe(g.value,i)}}}function dn(r){{var i=r.type;if(i==null||typeof i=="string")return;var l;if(typeof i=="function")l=i.propTypes;else if(typeof i=="object"&&(i.$$typeof===u||i.$$typeof===E))l=i.propTypes;else return;if(l){var d=F(i);Xt(l,r.props,"prop",d,r)}else if(i.PropTypes!==void 0&&!he){he=!0;var v=F(i);C("Component %s declared `PropTypes` instead of `propTypes`. Did you misspell the property assignment?",v||"Unknown")}typeof i.getDefaultProps=="function"&&!i.getDefaultProps.isReactClassApproved&&C("getDefaultProps is only used on classic React.createClass definitions. Use a static property named `defaultProps` instead.")}}function fn(r){{for(var i=Object.keys(r.props),l=0;l<i.length;l++){var d=i[l];if(d!=="children"&&d!=="key"){Y(r),C("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.",d),Y(null);break}}r.ref!==null&&(Y(r),C("Invalid attribute `ref` supplied to `React.Fragment`."),Y(null))}}function Qe(r,i,l,d,v,b){{var g=Vt(r);if(!g){var p="";(r===void 0||typeof r=="object"&&r!==null&&Object.keys(r).length===0)&&(p+=" You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports.");var O=cn(v);O?p+=O:p+=qe();var j;r===null?j="null":de(r)?j="array":r!==void 0&&r.$$typeof===t?(j="<"+(F(r.type)||"Unknown")+" />",p=" Did you accidentally export a JSX literal instead of a component?"):j=typeof r,C("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s",j,p)}var $=ln(r,i,l,v,b);if($==null)return $;if(g){var T=i.children;if(T!==void 0)if(d)if(de(T)){for(var V=0;V<T.length;V++)Ke(T[V],r);Object.freeze&&Object.freeze(T)}else C("React.jsx: Static children should always be an array. You are likely explicitly calling React.jsxs or React.jsxDEV. Use the Babel transform instead.");else Ke(T,r)}return r===o?fn($):dn($),$}}function pn(r,i,l){return Qe(r,i,l,!0)}function hn(r,i,l){return Qe(r,i,l,!1)}var gn=hn,xn=pn;H.Fragment=o,H.jsx=gn,H.jsxs=xn}()),H}process.env.NODE_ENV==="production"?ne.exports=er():ne.exports=rr();var n=ne.exports;const tr=({color:e="#000"})=>n.jsx("svg",{version:"1.1",xmlns:"http://www.w3.org/2000/svg",x:"0px",y:"0px",width:"40px",height:"40px",viewBox:"0 0 50 50",children:n.jsx("path",{fill:e,d:"M43.935,25.145c0-10.318-8.364-18.683-18.683-18.683c-10.318,0-18.683,8.365-18.683,18.683h4.068c0-8.071,6.543-14.615,14.615-14.615c8.072,0,14.615,6.543,14.615,14.615H43.935z",children:n.jsx("animateTransform",{attributeType:"xml",attributeName:"transform",type:"rotate",from:"0 25 25",to:"360 25 25",dur:"0.6s",repeatCount:"indefinite"})})});var me=(e=>(e.PRIMARY="primary",e.SECONDARY="secondary",e.TERTIARY="tertiary",e.DANGER="danger",e.SUCCESS="success",e.TRANSPARENT="transparent",e))(me||{});const be=({variant:e="primary",route:t,children:a,height:o=56,padding:s="11px 20px",leftIcon:f,radius:m="28px",buttonPadding:h,rightIcon:u,color:w,type:y,loading:E=!1,className:_,disabled:S=!1,fontWeight:R="600",...D})=>n.jsxs(nr,{className:_,$padding:s,$fontWeight:R,$variant:e,$height:o||40,type:y,disabled:S,$radius:m,...D,children:[f,E?n.jsx(tr,{color:"white"}):a,u]}),nr=c.button`
  ...
  width: 100%;
`;be.colors=me;const ir=be,or=({value:e,name:t,onChange:a,disabled:o=!1,label:s,error:f,className:m,intermediate:h})=>n.jsx(n.Fragment,{children:n.jsxs(ar,{disabled:o,className:m,onClick:()=>{!o&&a(!e)},children:[n.jsxs(lr,{intermediate:h,disabled:o,error:f,checked:e,children:[n.jsx(ur,{type:"checkbox",name:t,checked:e||!1,disabled:o,onChange:()=>{}}),n.jsx(cr,{checked:e||!1,intermediate:h,disabled:o})]}),n.jsx(sr,{children:s})]})}),ar=c.div`
  display: grid;
...
`,gr=fr,xr=({error:e})=>e?n.jsx(vr,{children:e}):n.jsx(n.Fragment,{}),vr=c.label`
  ...
  height: 2.4rem;
  margin-bottom: 8px;
`,mr=({error:e,showError:t=!0,label:a,className:o,padding:s="0",onClick:f,handleBlur:m,subLabel:h,bottomLabel:u,secondLabel:w,children:y})=>n.jsxs(br,{tabIndex:-1,onBlur:m,className:o,padding:s,onClick:f,children:[n.jsxs(wr,{children:[!!a&&n.jsxs($r,{children:[n.jsx(jr,{htmlFor:a,children:a}),!!h&&n.jsx(kr,{children:h})]}),w]}),y,t&&n.jsx(xr,{error:e}),u&&n.jsx(yr,{children:u})]}),br=c.div`
  display: block;
  position: relative;
  padding: ${({padding:e})=>e};
`,wr=c.div`
...
`,Vr=c.div`
  ...
  border-radius: 99px;
  cursor: pointer;
`,Nr=Wr,Hr=({mapHost:e,mapPath:t="/edit?types[]=point&buffer=xl",value:a,onChange:o,...s})=>{const f=x.useRef(null),m=x.useCallback(u=>{var w,y;u.origin===e&&o(JSON.parse((y=(w=u==null?void 0:u.data)==null?void 0:w.mapIframeMsg)==null?void 0:y.data))},[o]);x.useEffect(()=>(window.addEventListener("message",m),()=>window.removeEventListener("message",m)),[m]);const h=()=>{var u,w;a&&((w=(u=f==null?void 0:f.current)==null?void 0:u.contentWindow)==null||w.postMessage({geom:a},"*"))};return n.jsx(Ur,{src:`${e}${t}`,ref:f,width:"100%",allowFullScreen:!0,onLoad:h,"aria-hidden":"false",tabIndex:1,...s})},Ur=c.iframe`
  height: 400px;
  width: 100%;
  display: block;
...
`,Oe=rt,nt=({onClose:e,visible:t=!0,loggedIn:a,currentRoute:o,routes:s,onLogin:f,onLogout:m,onRouteSelected:h})=>n.jsx(Oe,{visible:t,onClose:e,children:n.jsx(ot,{children:n.jsxs(at,{children:[n.jsx(lt,{children:n.jsxs(st,{onClick:e,children:[n.jsx(it,{name:"close"}),"Uždaryti"]})}),n.jsxs(ct,{children:[n.jsx(ut,{children:"Meniu"}),n.jsx(dt,{children:"Pasirinkite dominančią sritį"})]}),s==null?void 0:s.map((u,w)=>n.jsx(_e,{isActive:u.slug===(o==null?void 0:o.slug),label:u.title||"",icon:u.iconName,onClick:()=>{h(u.slug),e()}},`menu_button_${w}`)),n.jsx(_e,{label:a?"Atsijungti":"Prisijungti",icon:I.logout,onClick:()=>{a?m():(f(),e())}})]})})}),it=c(z)`
  cursor: pointer;
  font-size: 2.4rem;
`,ot=c(oe)`
  width: 100%;
...
`,dt=c.div`
  ...
  margin-top: 4px;
  text-align: center;
`,Se=nt,ft=e=>{const{onGoBack:t}=e,[a,o]=x.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsxs(pt,{children:[n.jsx(vt,{onClick:t,children:n.jsx(xt,{name:I.back})}),n.jsxs(ht,{onClick:()=>o(!0),children:[n.jsx(gt,{name:I.burger}),"Meniu"]})]}),n.jsx(Se,{visible:a,...e})]})},pt=c.div`
  align-items: center;
  display: flex;
  gap: 8px;
  height: 80px;
...
`,mt=ft,bt=e=>{const{onGoHome:t,logo:a}=e,[o,s]=x.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsxs(wt,{children:[n.jsx("div",{onClick:t,children:a}),n.jsxs(yt,{onClick:()=>s(!0),children:[n.jsx(jt,{name:I.burger}),"Meniu"]})]}),n.jsx(Se,{visible:o,...e})]})},wt=c.div`
  align-items: center;
  display: flex;
  gap: 8px;
  height: 80px;
...
`,jt=c(z)`
  margin-right: 4px;
  font-size: 2rem;
`,$t=bt,kt=({loggedIn:e,loginSlug:t,routes:a,logo:o,onLogin:s,onLogout:f,onRouteSelected:m,currentRoute:h})=>n.jsxs(Ct,{children:[n.jsx(Et,{children:o}),a.map((u,w)=>n.jsxs(se,{onClick:()=>m(u.slug),$isActive:u.slug===(h==null?void 0:h.slug),children:[n.jsx(q,{name:u.iconName}),n.jsx(ae,{children:u.title})]},`sidebar_btn_${u.slug}_${w}`)),n.jsx(_t,{}),e?n.jsxs(se,{onClick:()=>f(),$isActive:!1,children:[n.jsx(q,{name:I.logout}),n.jsx(ae,{children:"Atsijungti"})]}):n.jsxs(se,{onClick:s,$isActive:t===(h==null?void 0:h.slug),children:[n.jsx(q,{name:I.logout}),n.jsx(ae,{children:"Prisijungti"})]})]}),Et=c.div`
  margin-bottom: 20px;
`,q=c(z)`
  cursor: pointer;
  font-size: 2.4rem;
...
`,_t=c.div`
  ...
  margin: 16px 0;
`,Ot=kt,St=e=>{var s;const{children:t,onScroll:a=()=>{}}=e,o=Xr(A.mobileL);return n.jsxs(Tt,{children:[!o&&n.jsx(Ot,{...e}),n.jsx(Pt,{onScroll:a,children:n.jsxs(Rt,{children:[(s=e==null?void 0:e.currentRoute)!=null&&s.back?n.jsx(mt,{...e}):n.jsx($t,{...e}),t]})})]})},Tt=c(oe)`
  width: 100vw;
  display: flex;
`,Pt=c.div`
  width: 100%;
...
`,Ft=({children:e,title:t,customSubTitle:a,customTitle:o,currentRoute:s})=>{const f=t||(s==null?void 0:s.title);return n.jsxs(Mt,{children:[o||f&&n.jsx(It,{children:f}),a||(s==null?void 0:s.description)&&n.jsx(Lt,{children:s==null?void 0:s.description}),e]})},Lt=c.div`
  color: ${({theme:e})=>e.colors.text.primary};
  margin-bottom: 16px;
`,Mt=c.div`
  display: flex;
...
`,It=c.div`
  ...
  margin: 16px 0;
  text-align: center;
`;k.Button=ir,k.CheckBox=dr,k.ContentLayout=Ft,k.DefaultLayout=St,k.FieldWrapper=ie,k.MapField=Hr,k.Modal=Oe,k.PasswordField=Dr,k.Switch=gr,k.Tabs=Nr,k.TextField=Or,Object.defineProperty(k,Symbol.toStringTag,{value:"Module"})});
