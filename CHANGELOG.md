...
- 0edd5b9: Bump maplibre-gl to ^6.4.1, which patches GHSA-jrc7-96c5-q579 (critical XSS: a
...
- b5b3343: fix(fields): a numeric field now shows a value set from outside
...
- 7062afa: feat(select): `minQueryLength` — don't search, and don't say "nothing found"
...
- 1676eb6: fix(tables): name the mobile expand controls and make them visible
...
- bd6e0ec: feat(tables): `defaultExpanded` opens every mobile row on load
